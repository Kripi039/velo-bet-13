...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-ab2db945');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-ab2db945');}
...
function clearFlash(){dieView.classList.remove('rl-win-ab2db945');dieView.classList.remove('rl-lose-ab2db945');if(frameEl){frameEl.classList.remove('rl-win-ab2db945');frameEl.classList.remove('rl-lose-ab2db945');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-ab2db945');if(frameEl){frameEl.classList.add('rl-win-ab2db945');}}else{dieView.classList.add('rl-lose-ab2db945');if(frameEl){frameEl.classList.add('rl-lose-ab2db945');}}
...
var brandEl=document.querySelector('.rl-brand-ab2db945');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
